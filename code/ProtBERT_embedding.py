...
@torch.no_grad()
def sliding_embed(sequence, window_size=1024, stride=512):
    ...
    for i in range(num_chunks):
        ...
        spaced = preprocess_sequence(chunk)
